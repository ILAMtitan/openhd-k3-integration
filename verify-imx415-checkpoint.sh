...
if [[ -r "$CAM" ]] && jq -e '.h26x_bitrate_kbits == 6000 and .h26x_keyframe_interval == 15' "$CAM" >/dev/null; then
  pass 'IMX415 bitrate/GOP is 6000/15'
else
  bad 'IMX415 bitrate/GOP is 6000/15'
fi
