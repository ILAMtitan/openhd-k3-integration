...
say 'Finishing Native-R1 application systemd boundary'
...
echo 'OpenHD remains stopped for staged Native-R1 qualification.'
echo 'The legacy bridge remains installed only for rollback/reference.'
echo 'Next: systemctl start openhd-k3-consumer.target'
echo 'Then run ./verify-consumer.sh and verify physical RF video.'
